  ...
  <div class="sticky-footer">
    <div class="sticky-content">
      ...
      <div class="container">
        ...
        <p class="content">
          POPO
          SHOP(以下簡稱本網站），為了讓您能夠安心使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益並立即生效，請您詳閱下列內容：
        </p>
        <div class="area">
          <p class="subtitle">一、隱私權保護政策的適用範圍</p>
          <p class="content">
        ...
        <div class="area">
          <p class="subtitle">二、個人資料的蒐集、處理及利用方式</p>
          <p class="content">
        ...
        <div class="area">
          <p class="subtitle">四、網站對外的相關連結</p>
          <p class="content">
        ...
        <div class="area">
          <p class="subtitle">五、與第三人共用個人資料之政策</p>
          <p class="content">
            本網站絕不會提供、交換、出租或出售任何您的個人資料給其他個人、團體、私人企業或公務機關，但有法律依據或合約義務者，不在此限。前項但書之情形包括不限於：<br />．經由您書面同意。<br />．法律明文規定。<br />．為免除您生命、身體、自由或財產上之危險。<br />．與公務機關或學術研究機構合作，基於公共利益為統計或學術研究而有必要，且資料經過提供者處理或蒐集著依其揭露方式無從識別特定之當事人。<br />．當您在網站的行為，違反服務條款或可能損害或妨礙網站與其他使用者權益或導致任何人遭受損害時，經網站管理單位研析揭露您的個人資料是為了辨識、聯絡或採取法律行動所必要者。<br />．有利於您的權益。<br />．本網站委託廠商協助蒐集、處理或利用您的個人資料時，將對委外廠商或個人善盡監督管理之責。
          </p>
        </div>

        <div class="area">
          <p class="subtitle">六、Cookie之使用</p>
          <p class="content">
        ...
        <div class="area">
          <p class="subtitle">七、隱私權保護政策之修正</p>
          <p class="content">
